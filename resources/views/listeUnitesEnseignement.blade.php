        ...
        <table class="min-w-full bg-white border text-center">
            ...
            <tbody>
                ...
                <tr class="border-t">
                    ...
                    <td class="py-3 px-4"><a href="{{ route('insertionEcu.store', ['ue' => $ue->id]) }}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">Ajouter une Ecu</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
